...
namespace Kaiak2
{
    public class PromocaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Promo,Nome_Promo,Valor_Promo")] Promocao promocao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Promo,Nome_Promo,Valor_Promo")] Promocao promocao)
        {
