...
namespace Kaiak2
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdContato,Nome,Sobrenome,Email,Telefone")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdContato,Nome,Sobrenome,Email,Telefone")] Contato contato)
        {
